...
- Skill: [`cs-onboard`](../../../c-level-advisor/skills/cs-onboard/SKILL.md) — the underlying interview protocol
- Skill: [`context-engine`](../../../c-level-advisor/skills/context-engine/SKILL.md) — reads this file
